...
def get_model(hidden_size=20, input_seq_len=12, shop_num=50, cate_num=100, embed_size=2, output_dim=1):
    # define model

    encoder_inputs_1 = Input(shape=(1,))
    encoder_inputs_2 = Input(shape=(1,))
    encoder_inputs_3 = Input(shape=(input_seq_len,))
    ...
    input_concatenated = Concatenate(axis=2)([encoder_inputs_1, shop_embeddings, cate_embeddings])
